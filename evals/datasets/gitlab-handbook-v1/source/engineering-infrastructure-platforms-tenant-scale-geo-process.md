---
slug: engineering-infrastructure-platforms-tenant-scale-geo-process
title: "Geo and Disaster Recovery - Planning"
source_url: "https://handbook.gitlab.com/handbook/engineering/infrastructure-platforms/tenant-scale/geo/process/"
...
If the problem is validated, the issue is moved forward to the next stage, otherwise it is closed with a short explanation on _why_ the problem will not be considered. This explanation should also contain
...
_Confidence: <!-- Percentage confidence level in the accuracy of this status -->_
