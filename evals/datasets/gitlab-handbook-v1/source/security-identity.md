...
source_url: "https://handbook.gitlab.com/handbook/security/identity/"
...
GitLab Identity v2 is what we do today and have been doing since 2018 with [baseline entitlements](https://internal.gitlab.com/handbook/eta/corporate-it/end-user-services/access-request/baseline-entitlements/) and [access requests](/handbook/eta/corporate-it/end-user-services/access-requests/access-requests/). See the [Access Management Policy](/handbook/security/security-and-technology-policies/access-management-policy/) to learn more.
...
For more details, see the related handbook pages or reach out to `#security-identity-eng` with questions.
...
The Identity Team collaborates cross-functionally with our [stable counterparts](/handbook/security/identity/counterparts).
